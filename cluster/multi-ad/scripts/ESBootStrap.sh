...
echo "discovery.zen.ping.unicast.hosts: ["${esmasternode1_private_ip}","${esmasternode2_private_ip}","${esmasternode3_private_ip}","${esdatanode1_private_ip}","${esdatanode2_private_ip}","${esdatanode3_private_ip}","${esdatanode4_private_ip}"]" >>/etc/elasticsearch/elasticsearch.yml 
