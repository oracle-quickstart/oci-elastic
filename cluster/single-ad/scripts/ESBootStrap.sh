...
esmasternode3=`host esmasternode3.privatenet|awk '{print $4}'`
esdatanode1=`host esdatanode1.privatenet|awk '{print $4}'`
esdatanode2=`host esdatanode2.privatenet|awk '{print $4}'`
esdatanode3=`host esdatanode3.privatenet|awk '{print $4}'`
