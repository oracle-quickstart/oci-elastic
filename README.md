...
Architecture Brief
==================
This deploys an Elastic cluster with 3 master nodes in all 3 ADs and 4 data nodes in 2 ADs. Necessary Elasticsearch is configured(parameter "cluster.routing.allocation.awareness.attributes")to make sure primary and replica of the same same index shard never stored in the same AD. 
